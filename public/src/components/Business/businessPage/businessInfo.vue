    ...
    <div class="columns">
                ...
                <div class="branch">
                  ...
                  <h6>
                    ...
                    <el-dialog
                      ...
                      >
                        <gmap-marker :position="branch.mapLocation" :clickable="true"
      ...
      <div class="column is-3">
        ...
        <div class="panel">
          ...
          <a class="dark-link panel-block" @click.prevent="relatedView(bus._id)"
             v-for="bus in related" :key="bus._id" :href="`/business/${bus._id}`">
            <p>
              {{ bus.name }}
                        </p>
          </a>
