    ...
    <div class="columns">
      ...
      <div class="column is-7 is-offset-1">
              ...
              <div class="content offerings">
                <div class="offering">
                  ...
                  <h6>
                        ...
                        >
                        <gmap-marker :position="offering.mapLocation" :clickable="true" :draggable="false"></gmap-marker>
                        </gmap-map>
                        </el-dialog>
                    </h6>
                  <h6>
              ...
              <div class="content reviews-content">
                <div class="review">
                  ...
                  <el-button-group class="is-pulled-right">
                    <el-button icon="information" @click="showReport(review)" v-if="clientID && !review.hasReported"></el-button>
                    <el-button icon="edit" @click="showEdit(review)" v-if="`${review._client._id}` === `${clientID}`">
                    </el-button>
                    <el-button type="danger" icon="delete" @click="showDelete(review)" v-if="`${review._client._id}` === `${clientID}`">
                    </el-button>
                  </el-button-group>
        ...
        <div class="columns" v-show="active === 3">
          <div class="column">
            <el-alert type="success" class="error" show-icon v-if="editReviewSuccess" :title="editReviewSuccess"></el-alert>
            <el-alert type="success" class="error" show-icon v-if="deleteReviewSuccess" :title="deleteReviewSuccess"></el-alert>
