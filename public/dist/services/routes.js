...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_client_Reset_vue__ = __webpack_require__(175);
        ...
        submitForm: function submitForm(formName) {
            ...
            this.$refs[formName].validate(function (valid) {
                if (valid) {
                    ...
                    _this2.form.post(__WEBPACK_IMPORTED_MODULE_1__services_EndPoints__["d" /* default */].Client().reset).then(function (data) {
                        _this2.form.success = true;
                    }).catch(function (err) {
                        _this2.form.fail = true;
                        console.log(err);
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-150eaa08", Component.options)
  } else {
    hotAPI.reload("data-v-150eaa08", Component.options)
  }
})()}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-150eaa08", module.exports)
  }
}
